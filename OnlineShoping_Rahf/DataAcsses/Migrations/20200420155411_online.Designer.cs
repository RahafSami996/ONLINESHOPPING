...
namespace DataAcsses.Migrations
{
    ...
    [Migration("20200420155411_online")]
            ...
            modelBuilder.Entity("OnlineShoppingSystem.Models.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, ConcurrencyStamp = "b2837809-46b1-4b38-9d62-eb0c328add21", Name = "Admin" },
                        new { Id = 2, ConcurrencyStamp = "04148f1e-31a3-4c0b-a441-8bdeb5ac0d61", Name = "Seller" },
                        new { Id = 3, ConcurrencyStamp = "82d5edf4-5be7-4426-9d4a-0d32e2a237e0", Name = "User" }
                    );
                });
            ...
            modelBuilder.Entity("OnlineShoppingSystem.Models.UserAdress", b =>
                {
                    ...
                    b.HasOne("OnlineShoppingSystem.Models.Order")
                        .WithMany("UserAdresses")
